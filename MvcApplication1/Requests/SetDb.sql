...
--insert into UserProfile(login,mail,password,secretquestion,secretanswer,age,fullname, role, avatar) 
--	select 'root','root@mail.com','root',SecretQuestions.Id,'root',null,'root', Roles.Id, null 
